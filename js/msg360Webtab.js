       ...
       $('#newLoad').show();
        ZOHO.CRM.CONFIG.getOrgVariable("message360sruthy.accSID").then(function(data) {
            ...
            ZOHO.CRM.CONFIG.getOrgVariable("message360sruthy.authToken").then(function(data) {
                ...
                request = {
                    url: "https://api.message360.com/api/v2/accounts/viewaccount.json",
                    params: {
                        AccountSid: accntSID,
                        returnType: "json",
                        date: tdate
...
function releaseNum(num,node) {
    $('#newLoad').show();
    request = {
        url: "https://api.message360.com/api/v2/incomingphone/releasenumber.json",
        params: {
            AccountSid: accntSID,
            returnType: "json",
            phonenumber: num
...
function listAvailableNumbers() {
        $('#newLoad').show();
    request = {
        url: "https://api.message360.com/api/v2/incomingphone/availablenumber.json",
        params: {
            AccountSid: accntSID,
            returnType: "json",
            numbertype: "sms",
...
function buyNumbers(index) {
    $('#newLoad').show();
    request = {
        url: "https://api.message360.com/api/v2/incomingphone/buynumber.json",
        params: {
            AccountSid: accntSID,
            returnType: "json",
...
function updateFriendlyName(phNo,node){
    ...
    request = {
        url: "https://api.message360.com/api/v2/incomingphone/updatenumber.json",
        params: {
            AccountSid: accntSID,
            returnType: "json",
            phonenumber: phNo,
